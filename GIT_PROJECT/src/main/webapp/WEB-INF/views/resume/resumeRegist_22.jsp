                ...
                <div class="col-12 col-md-9">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nameKor" class="form-control">
                        </div>
						...
						<div class="col-md-6">
                            ...
                            <input type="text" name="nameHan" class="form-control">
                        </div>	
                        <div class="col-md-6">
     ...
     <h3 class="section-title text-center">사회형평적 인재 우대사항(필수)</h3>
		...
		<div class="row mb-3">
		  ...
		  <div class="col-md-6 col-sm-12">
		    ...
		    <input type="text" name="veteranNumber" class="form-control resume-input" placeholder="보훈번호 입력">
		  </div>
		</div>
		...
		<div class="row mb-3">
		  ...
		  <div class="col-md-6 col-sm-12">
		    ...
		    <input type="text" name="disabilityGrade" class="form-control resume-input" placeholder="장애등급 입력">
		  </div>
		</div>
      ...
      <h3 class="section-title text-center">병역사항(필수)</h3>
		...
		<div class="row mb-3">
		  <div class="col-md-6 col-sm-12">
		    ...
		    <input type="date" name="enlistDate" id="enlist_date" class="form-control resume-input">
		  </div>
		  <div class="col-md-6 col-sm-12">
		    <label class="resume-label">전역일</label>
		    <input type="date" name="dischargeDate" id="discharge_date" class="form-control resume-input">
		  </div>
		</div>
		...
		<div class="row mb-3">
		  <div class="col-md-6 col-sm-12">
		    ...
		    <input type="text" name="exemptionReason" id="exemption_reason" class="form-control resume-input" placeholder="면제사유 입력">
		  </div>
		</div>
