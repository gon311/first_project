      ...
      <h3 class="section-title text-center">학력사항</h3>
		...
		<div class="row mb-3">
		  ...
		  <div class="col-md-6 col-sm-12">
		    ...
		    <input type="text" name="educationList[0].schoolName" class="form-control resume-input" placeholder="학교명 입력">
		  </div>
		</div>
		...
		<div class="row mb-3">
		  ...
		  <div class="col-md-6 col-sm-12">
		    ...
		    <input type="text" name="educationList[0].major" class="form-control resume-input" placeholder="전공명을 입력해주세요">
		  </div>
		</div>
		...
		<div class="row mb-3">
		  <div class="col-md-6 col-sm-12">
		    ...
		    <div class="d-flex">
		      <input type="text" name="educationList[0].hakjum" class="form-control resume-input me-2" placeholder="학점 입력">
		  ...
		  <div class="col-md-6 col-sm-12">
		    ...
		    <div class="d-flex">
		      ...
		      <input type="text" name="educationList[0].majorSub" id="educationList[0].majorSub" class="form-control resume-input" placeholder="추가 전공 입력">
		    </div>
		  </div>
		</div>
		...
		<div class="row mb-3">
		  <div class="col-md-6 col-sm-12">
		    ...
		    <input type="date" id="eduStartDay" name="educationList[0].eduStartDay" class="form-control resume-input">
		  </div>
		  <div class="col-md-6 col-sm-12">
		    <label class="resume-label">졸업</label>
		    <input type="date" id="eduEndDay" name="educationList[0].eduEndDay" class="form-control resume-input">
		  </div>
		</div>
		...
		<div class="row mb-3">
		  <div class="col-md-6 col-sm-12">
		    ...
		    <input type="text" name="experienceList[0].companyName"
		    		value="${resume.experienceList[0].companyName}" class="form-control resume-input" placeholder="기업명 입력">
		  </div>
		  
		  <div class="col-md-6 col-sm-12">
		    <label class="resume-label">근무부서</label>
		    <input type="text" name="experienceList[0].depatmentName"
		    		value="${resume.experienceList[0].depatmentName}" class="form-control resume-input" placeholder="근무부서 입력">
		  </div>
		</div>
