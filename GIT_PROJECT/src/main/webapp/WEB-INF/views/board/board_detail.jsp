  ...
  <div class="card">
    <div class="content">
      ...
      <div class="top-actions">
        <div>
          ...
          <!-- 카테고리 -->
          <span class="badge-cat">${post.boardType}</span>
        ...
        <div class="menu">
          ...
          <a class="btn-ghost" href="${urlBoardEdit}?postId=${post.postId}">
            수정
          </a>

          <form action="${urlBoardDelete}" method="post"
	...
	<c:if test="${not empty fileList}">
      ...
      <div class="bottom-actions">
        ...
        <a class="btn-dark" href="${urlBoardList}">
          목록
        </a>
